...
directorio_pruebas="tabbcalendario_prueba"
...
for test_file in "$directorio_pruebas"/tad*.cpp; do
    ...
    cp "$directorio_pruebas/tad$formatted_test_number.cpp.sal" "salida_esperada.cpp.sal"
